...
namespace Nop.Web.Framework
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<Nop.Services.Common.AddressService>().As<Nop.Services.Common.IAddressService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<Nop.Services.Employee.AddressService>().As<Nop.Services.Employee.IAddressService>().InstancePerLifetimeScope();
